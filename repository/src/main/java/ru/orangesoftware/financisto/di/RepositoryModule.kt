...
import ru.orangesoftware.financisto.repository.modern.AttributeRepositoryImpl
...
abstract class RepositoryModule {
    ...
    @Binds
    @Singleton
    abstract fun bindAttributeRepository(
        attributeRepositoryImpl: AttributeRepositoryImpl
    ): AttributeRepository
}
